const data = [ // _________________________________________Бонеты____________________________________________________
    {
...
const labels = document.getElementById('holod10');
