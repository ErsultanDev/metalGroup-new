const data = [ // ________________________________Холодильные шкафы с глухими дверьми_____________________________________________________
    {
        link: "cm105s.html",
...
const labels = document.getElementById('holod3');
