 const data = [
     ...
     {
         link: "holodilnaia_vitrina_tair_bhc_uh.html",
         ...
         link: "holodilnaia_vitrina_tair_bhc_ub.html",
         ...
         link: "holodilnaia_vitrina_parabel_bhc.html",
         ...
         link: "holodilnaia_vitrina_parabel_bhc_ub.html",
         ...
         link: "holodilnaia_vitrina_parabel_bhc_uh.html",
         ...
         link: "holodilnaia_vitrina_parabel_bhco.html",
 ...
 const labels = document.getElementById('holod8');
     ...
     array.map((a) => {
         ...
         <a href="${a.link}">
             ...
             <div class="cardProductItem_content">
                 <h3>${a.title} </h3>
                 <span class="cardProductItem_price">Цена: ${formatter(a.price)} тг</span>
             </div>
         </a>
     </div>
             </a>
