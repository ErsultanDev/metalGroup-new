...
const labels = document.getElementById('shkaf2Js');

const monoblocksBlock = document.getElementById('shkaf2Block');
...
function countParam(array) {
    ...
    return [sections1, sections2, sections3, sections4, sections5, razmer1, razmer1_2, razmer2, razmer3, razmer4, razmer5, razmer6, razmer7, color1, color2]
