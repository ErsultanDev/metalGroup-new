...
if (footerWrapper != null) {
  ...
  <div class="footer_address">
      <div class="footer_address_one">
          ...
          <a href="almaty.html"><b></b><br> 8 (727) 344-99-00<br>     </a>  
          <a href="almaty.html"><b></b> +7 (701) 266-77-00<br>     </a>  
      ...
      <div class="footer_address_two">
          ...
          <div class="footer_address_contacts">
          <a href="astana.html"><b></b><br> 8 (7172) 27-99-00 <br>     <div class="contact_info_text">
...
<div class="social-btns"><a class="btn instagram" href="https://www.instagram.com/idiamarket/"><i class="fa fa-instagram"></i></a><a
      class="btn twitter" href="https://t.me/Raihan_106"><i class="fa fa-telegram"></i></a><a class="btn google" href="https://api.whatsapp.com/send/?phone=77011018388&text&app_absent=0"><i
          class="fa fa-whatsapp"></i></a><a class="btn dribbble" href="https://www.youtube.com/channel/UCNDMIviMuZOhhCP7xoxGYAA/videos"><i
...
let feautured_h1 = document.querySelector(".featured h1");

if (feautured_h1 != null) {
  switch (urlCity) {
    case "almaty":
      $(feautured_h1).text($(feautured_h1).text().replace("В Алматы", ""));
      feautured_h1.textContent += ` в Алматы`;
      break;

    case "nursultan":
      $(feautured_h1).text(
        $(feautured_h1).text().replace("В Нур-Султан, Астана", "")
      );
      $(feautured_h1).text($(feautured_h1).text().replace("В Нур-Султан", ""));
      feautured_h1.textContent += ` в Нур-Султан, Астана`;
      break;

    case "shymkent":
      $(feautured_h1).text(
        $(feautured_h1).text().replace("купить Шымкент", "")
      );
      feautured_h1.textContent += ` в Шымкент`;
      break;
...
let sale_section = document.querySelector(".sale_section");

if (sale_section != null) {
  sale_section.innerHTML = `  <div class="sale_wrapper">
  <div class="sale_title">
      <h2>Сезонные скидки</h2>
  </div>
  <div class="saleSlider">
      <div class="sale_item">
          <a href="shkafodejda2.html">
              <div class="sale_item_img">
                  <img src="/images/fulls/shkaf_odejda/50.png" alt="">
              </div>
              <div class="sale_item_content">
                  <div class="sale_item_title">
                      <h3>Металлический шкаф <br> TSN 710-15310 </h3>
                  </div>
                  <div class="sale_item_price">
                      <div class="sale_item_price_new">
                          <span>38 629 ₸</span>
                      </div>
                      <div class="sale_item_price_old">
                          <span>68 177 ₸</span>
                      </div>
                  </div>
              </div>
      ...
      <div class="sale_item">
          <a href="shkafodejda2.html">
              <div class="sale_item_img">
                  <img src="/images/fulls/kas/kasNew17_4.png" alt="">
              </div>
              <div class="sale_item_content">
                  <div class="sale_item_title">
                      <h3>Кассовый бокс, универсальный зеленый </h3>
                  </div>
                  <div class="sale_item_price">
                      <div class="sale_item_price_new">
                          <span>117 192 ₸</span>
      ...
      <div class="sale_item">
          <a href="pristennaya_vitrina_carboma_tokyo.html">
              <div class="sale_item_img">
                  <img src="/images/fulls/holod/polus/pristen/2.png" alt="">
              </div>
              <div class="sale_item_content">
                  <div class="sale_item_title">
                      <h3>Пристенная холодильная витрина Carboma Tokyo </h3>
                  </div>
                  <div class="sale_item_price">
                      <div class="sale_item_price_new">
                          <span>874 573 ₸</span>
      ...
      <div class="sale_item">
          <a href="kassovyie_boksyi20_c2.html">
              <div class="sale_item_img">
                  <img src="/images/fulls/kas/kasNew20_2.png" alt="">
              </div>
              <div class="sale_item_content">
                  <div class="sale_item_title">
                      <h3>Кассовый бокс энергия, с двойным накопителем синий</h3>
                  </div>
                  <div class="sale_item_price">
                      <div class="sale_item_price_new">
                          <span>206 775 ₸</span>
      ...
      <div class="sale_item">
          <a href="scale_tb_m.html">
              <div class="sale_item_img">
                  <img src="/images/fulls/scale/92.png"" alt="">
       </div>
   <div class=" sale_item_content">
                  <div class="sale_item_title">
                      <h3>Весы ТВ-M_RP с <br> принтером этикеток</h3>
                  </div>
                  <div class="sale_item_price">
                      <div class="sale_item_price_new">
                          <span>64 530 ₸</span>
    ...
    style="background: linear-gradient(156deg, rgba(255,255,255,1) 0%, rgba(245,245,245,1) 65%);">
            ...
            <div class="product_slideImg">
                ...
                <div class="countProduct">
                  <div class="countImg">
                      <img class="count_pic1" src="/images/sloiProduct.png" alt="">
                      <img class="count_pic2" src="/images/sloiProduct2.png" alt="">
                  </div>
...
if (sort_wrapper != null) {
  sort_wrapper.insertAdjacentHTML("afterbegin", searchLog);
...
if (selectBoxMain != null) {
  selectBoxMain.innerHTML = `<div class="priceSortContainer">
  <div id="priceSort" class="select">
    <label for="select-box1" class="label select-box1"><span class="label-desc">
      <p class="sortedPo">Сортировать по:</p>
      <p class="sortedThree">популярности</p>
      <!-- <p class="sortedFour" style="display: none;">новизне</p> -->
      <p class="sortedFirst" style="display: none;">по возрастанию цены</p>
      <p class="sortedSecond">по убыванию цены</p>
    
    </span>
    <div class="priceContainer">
      <div name="threeT" class="priceOptionThree priceOptionThreeBg">
      популярности
      </div>
      <!-- <div name="fourT" class="priceOptionFour">
       новизне
      </div> -->
      <div name="firstT" class="priceOptionFirst">
       возрастанию цены
      </div>
...
// headingElem.addEventListener('click', function(e){
...
$(document).on("ready", function () {
  ...
  // $('.productSlider').on('mouseenter', '.slick-dots button', function (event) { $('.productSlider').slick('slickGoTo', $(this).parent().index()); });
});
$(function () {
  $(".btn-6")
...
const about_blag = document.querySelector('.about_blag');
