...
const data444 = [
  ...
  {
    link: "holodilnaia_vitrina_vitrina_eko_mini.html",
  ...
  {
    link: "holodilnaia_vitrina_vitrina_ilet_bhx.html",
  ...
  {
    link: "holodilnaia_vitrina_vitrina_ilet_bhc.html",
  ...
  {
    link: "holodilnaia_vitrina_vitrina_nova_bxh.html",
  ...
  {
    link: "holodilnaia_vitrina_vitrina_tair_bxh.html",
  ...
  {
    link: "holodilnaia_vitrina_vitrina_ilet_bxcd.html",
  ...
  {
    link: "holodilnaia_vitrina_vitrina_ilet_bxcho.html",
  ...
  {
    link: "holodilnaia_vitrina_tair_bxc_uh.html",
  ...
  {
    link: "holodilnaia_vitrina_tair_bxc_ub.html",
  ...
  {
    link: "holodilnaia_vitrina_parabel_bxc.html",
  ...
  {
    link: "holodilnaia_vitrina_parabel_bxc_ub.html",
  ...
  {
    link: "holodilnaia_vitrina_parabel_bxc_uh.html",
  ...
  {
    link: "holodilnaia_vitrina_parabel_bxco.html",
  ...
  {
    link: "pristennaya_vitrina_carboma_tokyo.html",
    ...
    img: "/images/fulls/holod/polus/pristen/2.png",
    price: 777410,
    code: "1718",
  },
  {
...

  {
    ...
    img: "/images/fulls/shkaf_odejda/50.png",
    price: 55783,
    code: "7002",
  },
...
if (col_8 != null) {
  let col_8Span = col_8.querySelector("span");
}
...
data444.forEach((item) => {
  if (filename === item.link) {
    try {
      if (col_8Span != null) {
        col_8Span.innerHTML = `Код товара: ${item.code}`;
      }
    } catch (e) {}
  }
});
...
let sortedThree= document.querySelector(".sortedThree");
let sortedFour = document.querySelector(".sortedFour");
...
let priceOptionThreeBg = document.querySelector(".priceOptionThree");
let priceArrow = document.querySelector(".fa-angle-down");
// let priceOptionFourBg = document.querySelector(".priceOptionFour");
...
try{
  selectTT.addEventListener("click", function (e) {
    ...
    priceArrow.classList.add('rotate-dropdown-arrow');
...
priceOptionFirstBg.addEventListener("click", function () {
  ...
  priceOptionThreeBg.classList.remove("priceOptionThreeBg");
  // priceOptionFourBg.classList.remove("priceOptionFourBg");
  priceArrow.classList.toggle('rotate-dropdown-arrow');
  sortedFirst.style.display = "block";
  sortedSecond.style.display = "none";
  sortedThree.style.display = "none";
  // sortedFour.style.display = "none";
  priceContainer.style.cssText = "display: none; opacity: 0;";
  selectTT.style.cssText = "border-radius: 13px;";
...
priceOptionThreeBg.addEventListener("click", function () {
  event.stopPropagation();
  priceOptionThreeBg.classList.add("priceOptionThreeBg");
  // priceOptionFourBg.classList.remove("priceOptionFourBg");
  priceOptionFirstBg.classList.remove("priceOptionFirstBg");
  priceOptionSecondBg.classList.remove("priceOptionSecondBg");
  priceArrow.classList.toggle('rotate-dropdown-arrow');
  ...
  sortedFirst.style.display = "none";
  sortedSecond.style.display = "none";
  sortedThree.style.display = "block";
  // sortedFour.style.display = "none";
  priceContainer.style.cssText = "display: none; opacity: 0;";
  selectTT.style.cssText = "border-radius: 13px;";
  selectBoxTT.classList.remove("open");
...
// priceOptionFourBg.addEventListener("click", function (event) {
//   event.stopPropagation();
//   priceOptionFourBg.classList.add("priceOptionFourBg");
//   priceOptionThreeBg.classList.remove("priceOptionThreeBg");
//   priceOptionSecondBg.classList.remove("priceOptionSecondBg");
//   priceOptionFirstBg.classList.remove("priceOptionFirstBg");
//   sortedFirst.style.display = "none";
//   sortedSecond.style.display = "none";
//   sortedThree.style.display = "none";
//   // sortedFour.style.display = "block";
//   priceSort.classList.remove("selectClassNames");
//   priceContainer.style.cssText = "display: none; opacity: 0;";
//   selectTT.style.cssText = "border-radius: 13px;";
//   selectBoxTT.classList.remove("open");
...
let btnDinamicWrapp = document.querySelector('#ggg .thirdly');

console.log(btnDinamicWrapp);
if(btnDinamicWrapp != null){
  btnDinamicWrapp.innerHTML= `<div class="dinamicBtnWrap">
