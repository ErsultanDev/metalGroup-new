const data = [
...

  {
    ...
    title: "Аксессуары для стеллажей",
    desc: "Вы можете выбрать дополнительные детали такого типа и размера, которые будут максимально подходить для создания нужного вам стеллажа. ",
    img: "/images/33.png",
    price: 156,
    product: "1",
    code: "1022",
...
const labels = document.getElementById("horest1Js");
...
// priceOptionFour.addEventListener("click", function () {
//   // priceSortedArray = data.forEach((item) => {
    ...
    item.innerHTML = `
        ...
        <span class="cardProductItem_code">Код товара: ${a.code}</span>
            ...
            <div class="cardProductItem_content">
                ...
                <span class="cardProductItem_price"> от ${formatter(
                  a.price
                )}  тг</span>
                </div>
...
function displayList(array) {
  ...
  array.map((a) => {
   ...
   <div class="secondly">
       ...
       <p>${a.desc}</p>
       <p><span class="item-price-indicator_second">Цена: от ${formatter(
         a.price
       )} тг </span></p>
       </div>
       </a>
